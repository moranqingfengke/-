...
exports.addbook = (req, res) => {
  ...
  db.query(sql, { bookname: bookinfo.bookname, bookauthor: bookinfo.bookauthor, bookaddress: bookinfo.bookaddress, bookprice: bookinfo.bookprice, bookdetail: bookinfo.bookdetail, bookstate: 0 }, function(err, results){
    if(err){
